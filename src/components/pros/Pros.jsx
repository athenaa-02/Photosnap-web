    ...
    return(
        ...
        <div className="container">
            <aside className='dark'>
                ...
                <a href="#">GET AN INVITE <svg xmlns="http://www.w3.org/2000/svg" width="43" height="14"><g fill="white" fill-rule="evenodd" stroke="#fff"><path d="M0 7h41.864M35.428 1l6 6-6 6"/></g></svg></a>
                </div>
            </aside>
        ...
        <div className="container">
            ...
            <aside className='light'>
                ...
                <a href="#">VIEW THE STORIES <svg xmlns="http://www.w3.org/2000/svg" width="43" height="14"><g fill="none" fill-rule="evenodd" stroke="#000"><path d="M0 7h41.864M35.428 1l6 6-6 6"/></g></svg></a>
            </div>
            </aside>
        </div>
        <div className="container">
